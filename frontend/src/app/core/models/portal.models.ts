...
export interface AssignmentItem { id: string; classSectionId: string; classSectionCode: string; courseCode: string; courseName: string; title: string; content: string; attachmentUrl: string; maxScore: number; openAt: string; dueAt: string; allowLate: boolean; latePenaltyPercent: number; cloCodes: string[]; linkedComponentId?: string; status: string; submissionCount: number; studentSubmissionStatus?: string; studentScore?: number; studentFeedback?: string; }
export interface SubmissionItem { id: string; assignmentId: string; studentId: string; studentCode: string; studentName: string; textContent: string; submittedAt: string; isLate: boolean; status: string; score?: number; feedback: string; resubmissionAllowed: boolean; }
