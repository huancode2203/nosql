...
public sealed class User:Document { public string Username{get;set;}=""; public string Email{get;set;}=""; public string? SecondaryEmail{get;set;} public string FullName{get;set;}=""; public string PasswordHash{get;set;}=""; public string Role{get;set;}="Student"; public List<string> Permissions{get;set;}=[]; public bool PermissionsConfigured{get;set;} public string Status{get;set;}="Active"; public string? StudentCode{get;set;} public string? LecturerCode{get;set;} public string? AvatarUrl{get;set;} public int FailedLoginCount{get;set;} public DateTime? LockedUntil{get;set;} public DateTime? LastLoginAt{get;set;} public List<RefreshToken> RefreshTokens{get;set;}=[]; }
